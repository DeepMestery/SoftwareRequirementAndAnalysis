...
<body>
<p style = "text-align: center;font-size: 30px;font-weight: bold;">技术审核</p>
<jsp:useBean id="db" class = "bean.JDBConnection"></jsp:useBean>
  <%
  	...
  	if(db.createConnection() == true) {
  		String sql = "select * from listinfo where xssh = '1' and bmsh = '0' and glcs = '"+Integer.parseInt(agencyname)+"'";
  		  	...
  		  	while(rs.next()) {
  		  		...
  		  		%>
  		  		  <tr>
  		  		    ...
  		  		    <td colspan = "2">
  		  		      <a href = "bmshST.jsp?number=<%=number %>" style = "text-decoration: none;">开始审核</a>
  		  		    </td>
  		  		  </tr>
  		  		<%
  		  	}
