...
function TG() {
	...
	var url = "bmshTG.jsp?jsxqname="+jsxqname;
	window.location = url;
}

function BTG() {
	var bmshyj = document.getElementById("bmshyj").value;
	var jsxqname = document.getElementById("jsxqname").value;
	...
	if(bmshyj == "") {
		...
		var url = "bmshBTG.jsp?jsxqname="+jsxqname+"&bmshyj="+bmshyj;
		window.location = url;
	}
}
</script>
...
%>
  ...
  <table border = "1" cellspacing = "0" cellpadding = "0" style = "position: absolute;left: 50px;top: 100px;"> 
    <tbody>
      ...
      %>
      <tr>
        <td colspan = "2">部门审核意见(“不通过”填写)</td>
        <td colspan = "4"><textarea rows="10" cols="80" id = "bmshyj"></textarea></td>
      </tr>
      <tr>
