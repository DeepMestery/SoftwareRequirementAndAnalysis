...
<body>
<p style = "text-align: center;font-size: 30px;font-weight: bold;">统计查询2</p>
<jsp:useBean id="db" class = "bean.JDBConnection"></jsp:useBean>
  <%
  	...
  	if(db.createConnection() == true) {
  		String sql = "select * from listinfo where xssh = '1' and bmsh = '0' and agencyname = '"+Integer.parseInt(agencyname)+"'";
  		  	...
  		  	while(rs.next()) {
  		  		...
  		  		%>
  		  		  <tr>
  		  		    ...
  		  		    <td colspan = "2">
  		  		      <a href = "bmsh_check.jsp?number=<%=number %>" style = "text-decoration: none;">查看详情</a>
  		  		    </td>
  		  		  </tr>
  		  		<%
  		  	}
